...
const SearchBooks = ({ loaderData }: Route.ComponentProps) => {
  ...
  return (
    <div className="h-hull flex flex-col gap-4 h-[calc(100vh-80px)]">
      <div className="flex w-full min-h-40 px-10 py-8 gap-8 flex-col md:flex-row bg-card flex-1">
        <SearchBooksFilters filters={query} />
        <SearchBookResults books={entries.data} />
      </div>
      <div className="h-fit justify-self-end mb-8">
